...
reject_event_test() ->
	Event=tika_event:reject_event(event(),user("Maike Meyenberg")),
	Contacts=Event#event.contacts,
	Contacts=[user("Gregor Meyenberg")].

add_user_to_event_test() ->
	Event=tika_event:add_user_to_event(event(),user("Gregor Meyenberg"),"456"),
...
remove_user_from_event_test() ->
	Event1= tika_event:add_user_to_event(event(),user("Gregor Meyenberg"),"456"),
	Event2= tika_event:add_user_to_event(Event1,user("Maike Meyenberg"),"456"),
	Event3= tika_event:remove_user_from_event(Event2,user("Gregor Meyenberg"),"456"),
